...
pin = function(button){
	...
	if (parentNode.dataset.minimized == "true"){
		...
		document.getElementById('pinwall').appendChild(parentNode);	
	}
...
generate_generic = function(arrayOfArraysEnum,arrayOfArrays,arrayOfInlinesEnum,name){
  	...
  	for(let i=0; i<arrayOfArrays.length;i++){
  		...
  		if(roll.substring(roll.length-6) === ("INLINE")){
  			...
  			roll += " (" + arrayOfInlinesEnum[roll.replaceAll(",","").replaceAll(" ", "_").replaceAll("'","$$$$$$")][Math.floor(Math.random()*arrayOfInlinesEnum[roll.replaceAll(",","").replaceAll(" ", "_").replaceAll("'","$$$$$$")].length)] + ")";
  		}
...
generate_Dice = function(name){
	...
	for (die in dice){
		output += "d" + dice[die] + ": " + Math.floor(Math.random()*dice[die]+1) + "<br>";
	}
	const myHeading = document.getElementById("generated_content");
  	myHeading.querySelector('.minimized').insertAdjacentHTML("afterend",'<div class="inGeneratedContent" data-minimized="false" data-category="'+
  	name.innerHTML.trim() +'">\n <p>'+output+
...
generate_Beast = function(name){
	...
	output = "A(n) " + beast + " beast: <br>";
	const func = "generate_Beast" + beast;
	window[func](name);
}
generate_BeastAberrant = function(name){
...
generate_Arena = function(name){
  ...
  const The_main_event_is = ["A battle royale or grand melee", "A reenactment of a historical battle", "A duel between two arena champions", "A duel between a champion and a severe underdog", "Feeding prisoners to beasts", "A battle of man versus beast INLINE", "A chariot race or foot race", "Feats of strength"];
...
generate_MilitaryCampArmorer = function(name){
...
generate_CraftingGuildArtisan = function(name){
  const The_artisan_has_the_experience_of = ["A young journeyman", "A mediocre journeyman", "A skilled journeyman", "A veteran of the craft", "A master of the craft", "An old crafter"];
...
generate_Brothel = function(name){
  ...
  const arrayOfArraysEnum ={The_locals_call_this_place_the,Cont_,The_brothel_is_located,In_addition_to_the_$$$usual$$$_amusements_here_you_can_procure,The_place_is_run_by,To_eat_the_place_serves,To_drink_the_place_serves,People_talk_they_say,People_talk_about_this_place_rumors_suggest_that_recently,This_room_has,You_notice};
  const arrayOfArrays = [The_locals_call_this_place_the,Cont_,The_brothel_is_located,In_addition_to_the_$$$usual$$$_amusements_here_you_can_procure,The_place_is_run_by,To_eat_the_place_serves,To_drink_the_place_serves,People_talk_they_say,People_talk_about_this_place_rumors_suggest_that_recently,This_room_has,You_notice];
  const arrayOfInlinesEnum ={You_can_pay_for_services_with_things_other_than_coin};
  generate_generic(arrayOfArraysEnum,arrayOfArrays,arrayOfInlinesEnum,name);};

generate_MilitaryCampFollower = function(name){
...
generate_BeastCelestial = function(name){
...
generate_MilitaryCampCommander = function(name){
...
generate_MilitaryCampCook = function(name){
...
generate_UndeadCorporeal = function(name){
...
generate_CraftingGuild = function(name){
...
generate_Cult = function(name){
  const The_cultists_revere = ["A dragon", "A demon lord", "An archdevil", "A longdead ancient hero INLINE", "A longdead ancient villain INLINE", "A dead god or undead being", "An aberrant creature INLINE", "An elemental creature", "A primordial or titan", "Primal spirits or an archfey", "An exarch of a god", "The cult’s own mortal leader"];
  const A_longdead_ancient_hero = ["bard", "beastmaster", "elfmaid or prince", "knight or crusader", "hunter", "prophet"]; 
  ...
  const The_cultists_meet_in = ["A secret chamber in a wellknown temple", "The cellar of a popular tavern", "A secret chamber in a large guildhall", "The cellar of a wealthy merchant's house", "The city sewers", "Ancient catacombs beneath the city", "A cabin in the countryside", "A creepy, dark cave", "A heavily guarded chamber within a castle", "The stacks of a wellstocked library"];
  const The_cult$$$s_leader_is = ["A devoted acolyte", "A dogmatic teacher", "An adept healer", "A charismatic preacher", "An eccentric scholar", "An outspoken zealot", "A dangerous megalomaniac", "A charismatic demagogue", "A mysterious foreigner", "A wellknown public figure", "A ruthless killer", "A femme fatale", "A charming rogue", "A powerful noble", "A talented artist", "A religious fanatic", "A veteran soldier", "A humble artisan", "An ancient hero reborn", "The second coming of a god"];
  ...
  const The_cult$$$s_practices_involve = ["Animal sacrifice INLINE", "Human sacrifice INLINE", "Selfmutilation INLINE", "Burnt offerings INLINE", "Offerings of gold, gems, and valuables", "Strange incantations", "Public acts of violence INLINE", "Ritualistic sexual acts INLINE"];
  ...
  const Burnt_offerings = ["corpses", "rare herbs", "sacred incense", "highquality meat", "nonbelievers", "prisoners"]; 
  ...
  const The_cult$$$s_goals = ["Domination of the city", "Destruction of the city", "Reincarnation of a longdead entity", "Declaration of war against a rival city", "Rebellion against the city's elite", "Death to nonbelievers", "Opening a portal to another plane", "Release of a powerful captive entity"];
  const The_cult$$$s_members_must_follow_a_strict_rule_regarding = ["Wearing a flower in the hair or on the lapel INLINE", "Fashion trends", "Maintaining their personal weapon INLINE", "Treatment of pets", "Mounting a horse", "Dressing one’s self for worship", "Dressing one’s self for daytoday activities", "Diet", "Exercise routines", "Bathing", "Styling one’s hair", "Brushing one’s teeth"];
...
generate_CultCultist = function(name){
...
generate_CavernDarkElf = function(name){
...
generate_BeastDemonic = function(name){
...
generate_DesertDesert = function(name){
...
generate_Disease = function(name){
...
generate_Dungeon = function(name){
...
generate_MineMinerDwarf = function(name){
...
generate_ForestZEnchanted = function(name){
...
generate_ForestZEnchantedFaerieFolk = function(name){
...
generate_BeastFey = function(name){
...
generate_BeastFire = function(name){
...
generate_FisherFolk = function(name){
...
generate_FisherFolkBoat = function(name){
...
generate_ArenaGladiator = function(name){
...
generate_GoblinGang = function(name){
...
generate_ForestZZHauntedForestGraverobber = function(name){
...
generate_ForestZZHauntedForest = function(name){
...
generate_DiseaseHealer = function(name){
...
generate_DruidHerblore = function(name){
...
generate_ElfHigh = function(name){
...
generate_UndeadIncorporeal = function(name){
...
generate_BeastInfernal = function(name){
...
generate_BeastLegendary = function(name){
...
generate_LizardfolkJungle = function(name){
...
generate_PackLycanIndividual = function(name){
  ...
  const The_beastshifter_transforms_into = ["A grizzly bear", "A black bear", "A wild boar", "An oversized black rat", "A large brown rat", "A lanky grey rat", "A fierce tiger", "A grey wolf", "A mottled brown and grey wolf", "A reddish brown wolf", "A dark brown or black wolf", "A white wolf", "An uncommon form INLINE"];
  ...
  const An_uncommon_form = ["A leopard", "A badger", "A lion", "A bat", "An owl", "A cat", "A panther", "A crocodile", "A raven", "A dog", "A seal", "A dolphin", "A serpent", "A fox", "A shark", "A hyena", "A spider", "A jackal", "A swine", "A jaguar"];
  const If_it_hunts_the_beastshifter$$$s_favorite_prey_are = ["Foreigners and travelers", "Beggars and drunks", "Young men", "Young women", "Old women", "Old noblewomen", "Priests and monks", "Priestesses", "Harlots and madames", "Farmwives and peasant girls", "Young children", "Rabbits and hares", "Squirrels and chipmunks", "Pheasants and other gamefowl", "Ducks and other waterfowl", "Mice and rats", "Pigeons and doves", "Sheep and goats", "Chickens and turkeys", "Dogs and cats"];
  const arrayOfArraysEnum ={In_humanoid_form_the_beastshifter_presents_himself_or_herself_as,The_beastshifter_transforms_into,The_beastshifter_transforms_involuntarily,While_transformed_the_beastshifter_behaves,The_beastshifter_has_a_tendency_to,The_beastshifter_lives,The_beastshifter_makes_his_or_her_home,In_humanoid_form_the_beastshifter$$$s_face_has,In_humanoid_form_the_beastshifter_fights_with,If_it_hunts_the_beastshifter$$$s_favorite_prey_are};
  const arrayOfArrays = [In_humanoid_form_the_beastshifter_presents_himself_or_herself_as,The_beastshifter_transforms_into,The_beastshifter_transforms_involuntarily,While_transformed_the_beastshifter_behaves,The_beastshifter_has_a_tendency_to,The_beastshifter_lives,The_beastshifter_makes_his_or_her_home,In_humanoid_form_the_beastshifter$$$s_face_has,In_humanoid_form_the_beastshifter_fights_with,If_it_hunts_the_beastshifter$$$s_favorite_prey_are];
  const arrayOfInlinesEnum = {An_uncommon_form};
  generate_generic(arrayOfArraysEnum,arrayOfArrays,arrayOfInlinesEnum,name);};

generate_GoblinGangIndividual = function(name){
...
generate_MercenaryIndividual = function(name){
...
generate_Mercenary = function(name){
...
generate_MerchantGuild = function(name){
...
generate_MilitaryCamp = function(name){
...
generate_MineMiner = function(name){
...
generate_Monastry = function(name){
...
generate_MonastryMonk = function(name){
...
generate_Mountain = function(name){
...
generate_ForestZZHauntedForestNecromancer = function(name){
...
generate_Neighbourhood = function(name){
...
generate_NobleHouse = function(name){
...
generate_NobleHouseIndividual = function(name){
...
generate_NPC = function(name){
  ...
  const which_sit_above = ["A crooked nose", "A bulbous nose", "A narrow nose", "A button nose", "A long nose", "A broad nose", "An angular nose", "A round nose"];
...
generate_OrcClan = function(name){
...
generate_OrcClanIndividual = function(name){
...
generate_OutlawsIndividual = function(name){
...
generate_Outlaws = function(name){
...
generate_PackLycan = function(name){
...
generate_Pickpocket = function(name){
  const In_the_mark$$$s_pocket_the_thief_finds = ["A scrap of paper or parchment with an unintelligible note scribbled on it", "A scrap of paper or parchment with a list of mundane items or tasks written on it", "Some lint or a bit of thread", "A lost button or broken piece of something", "An old or well-worn key ", "A new or little-used key ", "A clean handkerchief ", "A soiled handkerchief ", "A score", "A score as well as INLINE"];
  const A_score_as_well_as = ["A scrap of paper or parchment with an unintelligible note scribbled on it", "A scrap of paper or parchment with a list of mundane items or tasks written on it", "Some lint or a bit of thread", "A lost button or broken piece of something", "An old or well-worn key ", "A new or little-used key ", "A clean handkerchief ", "A soiled handkerchief "]; 
  ...
  const If_the_thief_scores = ["1d​6 sp plus 1d​10 cp", "2d​4 cp", "2d​6 sp plus 1d​10 cp", "3d​​6 cp", "1d​4 gp plus 1d​10 sp", "1d​6 sp", "2d​4 gp plus 1d​10 sp", "2d​6 sp", "1d​4 gp", "A gem or small piece of jewelry (5d​10 gp)", "A gem (5d​10 gp) and roll this table again", "1d​6 gp and roll this table again"];
  const arrayOfArraysEnum ={In_the_mark$$$s_pocket_the_thief_finds,The_key_is,The_handkerchief_is,If_the_thief_scores};
  const arrayOfArrays = [In_the_mark$$$s_pocket_the_thief_finds,The_key_is,The_handkerchief_is,If_the_thief_scores];
  const arrayOfInlinesEnum ={A_score_as_well_as};
  generate_generic(arrayOfArraysEnum,arrayOfArrays,arrayOfInlinesEnum,name);
  };

generate_PiratesIndividual = function(name){
...
generate_PoacherOutlaws = function(name){
...
generate_TemplePriest = function(name){
...
generate_DungeonPrisoner = function(name){
  ...
  const arrayOfArraysEnum ={The_prisoner_has,The_prisoner_is_here_because,The_prisoner_has_};
  const arrayOfArrays = [The_prisoner_has,The_prisoner_is_here_because,The_prisoner_has_];
  const arrayOfInlinesEnum = {};
  generate_generic(arrayOfArraysEnum,arrayOfArrays,arrayOfInlinesEnum,name);};

generate_QuartermasterCamp = function(name){
...
generate_Retainer = function(name){
...
generate_OutlawsRobber = function(name){
...
generate_SavageHorde = function(name){
...
generate_SavageHordeIndividual = function(name){
...
generate_BeastSea = function(name){
...
generate_SerialKiller = function(name){
...
generate_BeastShadow = function(name){
...
generate_OutlawsSmuggler = function(name){
...
generate_JungleSnakeCultist = function(name){
...
generate_SoldierIndividualCamp = function(name){
...
generate_DesertSpooky = function(name){
...
generate_BeastStorm = function(name){
...
generate_TheWatch = function(name){
...
generate_TheWatchGuard = function(name){
...
generate_TheWatchInvestigator = function(name){
...
generate_Thieves2 = function(name){
...
generate_MerchantGuildTradingCompany = function(name){
...
generate_ForestZEnchantedTreefolk = function(name){
...
generate_BeastUndead = function(name){
...
generate_UrbanGang = function(name){
...
generate_UrbanGangMember = function(name){
...
generate_Vampire = function(name){
...
generate_DesertWasteland = function(name){
...
generate_BeastWinter = function(name){
...
generate_ElfWood = function(name){
  ...
  generate_generic(arrayOfArraysEnum,arrayOfArrays,arrayOfInlinesEnum,name);};
generate_ForestWoodsman = function(name){
